...
* The basic format is:
	...
	* you may continue adding *no*'s to specify grandfather and so on
* Example:
	* Given name: Hajira (Angel)
	* Family name: Sumatà (Courageous)
	* Father's name: Aiu (Fire/flame/ambition)
	* Constructed:
...
* Younger siblings usually never refer to older siblings by their first name but can drop hon'iku or 'iku
...
* Use *hon* after a family name to refer to your parent, older sibling, etc.
	* *Samatàhon* or *Samatàhon'iku*
* For first names, *hon* is never used; however, *'iku* is depending on context, ambiguity, and all the aforementioned things

...
* The root usually changes depending on animacy:
	* *Nemurra payaennai boji hakashisun ye* :: `choice-NEG study-GER-MID AGST-LOC family-1SG.POSS BEN`
		* ~"No choice but to study for my family"
			* here, *hakashisun* likely refers to parents
	* *Karisun a payanamai suoe* :: `parent-1SG.POSS A study-MID.TR 1SG-N`
		* ~"My parents made me study"
			* here, *karisun* refers to parents
...
* *wu* is the only inanimate pronoun in Koyeah Tawa
	...
	* instead, you use *so* (3SG.M) until you learn their sex
* *wu* also can't be used for any living thing:
	* for nature, you use *sa* (3SG.F), unless you know the animal's sex
		* ungendered organisms like plants are always *sa*
	* using *wu/wun* for living things like birds or plants is an insult to nature, which is a severe, extreme taboo
	* *wu* refers to things humans have made artificially, like a plastic water bottle
		* for things that humans didn't make, like mountains, *wumei* or *sa* is still used
		* if the mountain has significance or isn't neutral (e.g., 'just a random mountain'), you use *sa*
		* if you're talking about a random rock on the street, you use *wumei*

### 16.2.1 *mei* exception
* *wu* is innately inanimate (`3SG.INAN`)
* So when you make it animate *wumei* (`3SG-AN`), it doesn't actually refer to any animate being
* It refers to objects that have had 'nature's' spark in them
* A rock was not crafted by man, it was crafted by her (i.e., nature)
...
* Which pronoun would be used depending on type:
	* **artificial inanimate**
		* *wu* is used
			* plastic water bottles, an aeroplane, or a train
	* **natural inanimate**
		* *wumei* is used
			* a random rock, dust, dirt
	* **natural animate & inanimate**
		* *sa* is used for **natural animate**
			* birds, plants, any living thing
		* but it also used for specific types of **natural inanimate**
			* great mountains, stars, planets, the Earth's dirt and natural materials, oceans, water
...
* If a rock fell on you, you'd use *wumei*, because:
	* a random rock is not significant, especially not to you in such a circumstance
* But for Mt. Fuji and Everest, you'd use *sa*, because:
	* they're beautiful scenic creations of nature
...
* *su*, *sa*, *na*, *so*, *za*, amongst others have literal meanings:
	...
	* *zu* means 'the deuce / the other' (*zuoe*)
		...
		* and yes, the pronouns can be used in card games:
			...
			* *saoe* :: queen
			* *sōe* :: king
		* the **Jack** card just uses:
			* *jakku* or, less commonly, *jisuoe*
